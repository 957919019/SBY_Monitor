...
public class AdapterDownloading extends RecyclerView.Adapter<AdapterDownloading.MyViewHolder>
{
    ...
    {
        void stop(int cityId, int position);
    }
    ...
    public AdapterDownloading(Context context, ArrayList<MKOLUpdateElement> list)
    {
        this.list = list;
    ...
    private void switchStatus(MyViewHolder holder, int status, final int position, final MKOLUpdateElement e)
    {
        switch (status)
        {
            case 1: // 下载中
                ...
                holder.bt_start.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        {
                            ToastUtil.toast("点到暂停");
                            stopListener.stop(e.cityID, position);
                        }
                    }
                });
                break;
