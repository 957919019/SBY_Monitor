...
public class DateUtils
{
     ...
     * Log输出标识
     **/
    private static final String TAG = "fzl";
     ...
     * 获取系统时间 年月日
     */
    public static String getFormateYMD()
    {
//        Calendar calendar = Calendar.getInstance();
...
//        int day = calendar.get(Calendar.HOUR_OF_DAY);
    ...
    /**
     * 比较是否大于当前时间
     * return trur:startTime 比系统时间晚或相等
     */
    public static boolean compareWithSyatemDate( Date startTime)
    {
        return DateUtils.compareDate(startTime, DateUtils.strToDate(DateUtils.getFormateYMD()));
    }
    ...
    public static String getCurrentDateString()
    {
        ...
        format = new SimpleDateFormat("yyyy年MM月dd日HH时mm分");
        return format.format(Calendar.getInstance().getTime());
    }
    ...
    public static boolean isSameDay(String str1, String str2)
    {
        ...
        day1 = DateUtils.strToDate(str1);
        day2 = DateUtils.strToDate(str2);
